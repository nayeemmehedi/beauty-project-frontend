    ...
    <div className="mt-16">
      ...
      <div className="grid grid-cols-4">
          ...
          <div className=" mx-auto py-8 ">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="ms-3">
                ...
                <button
                  onClick={AddProduct}
                  className="mainbg hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded"
                >
                  Add to Cart
                </button>
                ...
                <div className="me-7">
                  ...
                  <p className="mt-2 font-light">{product.calagories}</p>
        ...
        <div className="col-span-1">
          <Recommended product={product}></Recommended>
        </div>
      </div>
    </div>
  );
